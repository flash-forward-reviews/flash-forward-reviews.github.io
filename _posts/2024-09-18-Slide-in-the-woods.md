...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw1.png" caption="" alt="" %}{:target="_blank"}

## Skeeter's Take:

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw2.png" caption="" alt="" %}{:target="_blank"}

A slide. I’m not sure why I’m here, standing in front of a slide. This strange disembodied slide attached to nothing.

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw3.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw4.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw5.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw6.png" caption="The Knife from Psycho plays" alt="" %}{:target="_blank"}

AND A SLENDERMAN NOTE

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw7.png" caption="Chug-Jug With You from Levithan plays" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw10.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw11.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw12.png" caption="" alt="" %}{:target="_blank"}

My new function seems to be crawling. I crawl until I reach the end of the tunnel and find… Ruins? 

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw13.png" caption="" alt="" %}{:target="_blank"}

And a sacrificial altar: 

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw14.png" caption="" alt="" %}{:target="_blank"}

The Aztec death whistle being my clue, I correctly identify these ruins as Mayan. 

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw15.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw16.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw17.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw18.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw19.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/sitw20.png" caption="" alt="" %}{:target="_blank"}
