...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall1.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall2.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall3.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall4.png" caption="" alt="" %}{:target="_blank"}

Alright, so we can set up our stats for our class... but then what are these?

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall5.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall6.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall7.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall8.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall9.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall10.png" caption="" alt="" %}{:target="_blank"}

Alright, we’re almost there I think, now it’s time for

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall11.png" caption="" alt="" %}{:target="_blank"}

I can not move this. I do not know what it does. We will come back to this, don’t you worry. Aight next we have:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall12.png" caption="" alt="" %}{:target="_blank"}

We can just choose our max hit points per level? Damn seems like we should bump that up...

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall13.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall14.png" caption="" alt="" %}{:target="_blank"}

Do you hate Kite Shields with an unexplainable passion? Take the Forbidden Kite Shield disadvantage!

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall15.png" caption="" alt="" %}{:target="_blank"}

Wanna be scared of  humanoids? What does that do? SHUT UP WHO CARES!

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall16.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall17.png" caption="" alt="" %}{:target="_blank"}
...
Finally, you can choose which groups like and hate you personally, I don’t FUCK with peasants OR the nobility.

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall18.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall19.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall20.png" caption="" alt="" %}{:target="_blank"}

We answer a few questions and commit to a life of fame:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall21.png" caption="" alt="" %}{:target="_blank"}

THEN THE GAME COMMANDS YOU WITH THE BIGGEST TEXT I’VE EVER SEEN IN MY LIFE:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall22.png" caption="" alt="" %}{:target="_blank"}

We do it.

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall23.png" caption="" alt="" %}{:target="_blank"}

We CHOOSE THY FACE

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall24.png" caption="" alt="" %}{:target="_blank"}

And then we’re finally done.

Except for the bonus points.

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall25.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall26.png" caption="" alt="" %}{:target="_blank"}

Then choose how much of a gamer you are:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall27.png" caption="" alt="" %}{:target="_blank"}

Then FINALLY you are done:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall28.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall29.png" caption="" alt="" %}{:target="_blank"}
...
After choosing Skyrim. I was prompted to either pick a class, create my own, or take a quiz to determine my class. I opted to create my own class to get me closer to Human:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall30.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall31.png" caption="" alt="" %}{:target="_blank"}

I even gave myself some very human disadvantages:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall32.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall33.png" caption="As a human, I obviously boss people around" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall34.png" caption="Nothing more human than a book!" alt="" %}{:target="_blank"}

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall35.png" caption="…Do I even need to say it?" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall36.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall37.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall38.png" caption="Break in case of human emergency!" alt="" %}{:target="_blank"}

After a quick patch job, my hands are sweaty, but my build is completed - I am human:

{% include figure.html image="https://raw.githubusercontent.com/flash-forward-reviews/img/refs/heads/main/img/daggerfall39.png" caption="I promise this will all make sense one day." alt="" %}{:target="_blank"}
