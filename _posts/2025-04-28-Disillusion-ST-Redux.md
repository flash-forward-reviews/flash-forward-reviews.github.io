...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst1.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst2.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst3.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst4.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst5.png" caption="" alt="" %}{:target="_blank"}

And the thing that made me feel the most at home… 

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst6.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst7.png" caption="" alt="" %}{:target="_blank"}

We are so back, baby!

After going through a few doors, and exploring a few pretty places…

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst8.png" caption="" alt="" %}{:target="_blank"}

I’m met by some anime doll thing promising to warp me to magical places.

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst9.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst10.png" caption="" alt="" %}{:target="_blank"}

I wander around Silent Hill talking to the strange characters. That’s right! It’s another round of Weirdo Appreciation! 

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst11.png" caption="Cyclops Squidward!" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst12.png" caption="Scary man don’t talk to me at night!" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst13.png" caption="Hey wait I know you!" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst14.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst15.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst16.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst17.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst18.png" caption="Eavesdropper!" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst19.png" caption="I didn’t even have the choice to use mine. I’d give up my left hand for a piece of magical metal worm body. It seems only fair." alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst20.png" caption="OH, DO YOU THINK?" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst21.png" caption="" alt="" %}{:target="_blank"}

The metal worm reveals why he needs parts to a body: 

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst22.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst23.png" caption="Credit: Sam Cain - circa 2025 - “image.png”" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst24.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst25.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst26.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst27.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst28.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst29.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst30.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst31.png" caption="" alt="" %}{:target="_blank"}

Also this game has Fallout New Vegas in it:

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst32.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img3/blob/main/img/disst33.png" caption="" alt="" %}{:target="_blank"}
