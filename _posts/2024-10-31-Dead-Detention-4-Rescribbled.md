...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet1.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet2.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet3.png" caption="" alt="" %}{:target="_blank"}

11:08 - The screenshot of a funny ABC face is obligatory at this point

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet4.png" caption="" alt="" %}{:target="_blank"}

Mom on the line. She’s flying a helicopter. Badass. 
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet5.png" caption="" alt="" %}{:target="_blank"}

But the asshole in me had more control and ABC just stayed silent: 

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet6.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet7.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet8.png" caption="It’s 5 episodes and an epilogue if you get a good ending, not technically 6 episodes" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet9.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet10.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet11.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet12.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/4dedet13.png" caption="" alt="" %}{:target="_blank"}
