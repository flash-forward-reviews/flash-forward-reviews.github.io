...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis1.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis2.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis3.png" caption="" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis4.png" caption="Look at that RESOLUTION" alt="" %}{:target="_blank"}

Exmortis leans a little too heavy on it’s gore for my taste - but the head in the microwave was very funny:

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis5.png" caption="" alt="" %}{:target="_blank"}

And unfortunately for me, Exmortis also leans heavily on exposition told through 6 pages of reading per book: 

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis6.png" caption="Skimmed this one - guy loses his mind or something" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis7.png" caption="Wasn’t about to try to decipher this font. G.R. had a daughter named Gwen and something sad happened." alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis8.png" caption="Look! It’s her! The one from the stories!" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis9.png" caption="Blood = Scary" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis10.png" caption="" alt="" %}{:target="_blank"}

So naturally, I search the house for clues with any sort of number sequence I can find:

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis11.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis12.png" caption="Mmm, yes. Some nice textures." alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis13.png" caption="Nothing" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis14.png" caption="" alt="" %}{:target="_blank"}

Alright, you got it? I’m guessing you probably noticed the door, the light, maybe the rug, and the old oak side table:

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis15.png" caption="" alt="" %}{:target="_blank"}

But did you happen to notice the attic? BECAUSE I SURE DIDN’T!

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis16.png" caption="" alt="" %}{:target="_blank"}

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis17.png" caption="Thank you Tab-Highlight. Thank you." alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis18.png" caption="The fucking safe code" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis19.png" caption="" alt="" %}{:target="_blank"}

A bloody symbol, A human(?) heart, and a… wait… no… it can’t be.. NOOOOOOOOOOOOOOOOOOOOOO

{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis20.png" caption="tl;dr Skipped to the picture" alt="" %}{:target="_blank"}
...
{% include figure.html image="https://github.com/flash-forward-reviews/img2/blob/main/img/exmortis21.png" caption="" alt="" %}{:target="_blank"}
